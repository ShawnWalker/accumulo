...
public class GarbageCollectWriteAheadLogsTest {
  ...
  {
    try {
      tabletAssignedToServer1 = new TabletLocationState(extent, (TServerInstance) null, server1, (TServerInstance) null, walogs, false, null);
      tabletAssignedToServer2 = new TabletLocationState(extent, (TServerInstance) null, server2, (TServerInstance) null, walogs, false, null);
    } catch (Exception ex) {
